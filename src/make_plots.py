...
plt.xlabel("Shift x", size = 20)
plt.ylabel("Shift y", size = 20)
plt.title("Shift Comparison", size = 20)
plt.legend()
...
plt.xlabel("Observation index", size = 20)
plt.ylabel("Absolute rotation error (degrees)", size = 20)
plt.title("Rotation absolute error by observation", size = 20)
plt.legend()
plt.tight_layout()
